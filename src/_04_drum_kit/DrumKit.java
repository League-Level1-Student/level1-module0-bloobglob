...
String imageFile = "cymbal.jpg";
		// 9. Edit the next line to use your String variable
		drumLabelWithImage = createLabelImage(imageFile);
...
String imageFile2 = "snare.jpg";
drumLabelWithImage2 = createLabelImage(imageFile2);
